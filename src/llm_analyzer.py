    ...
    for fund in funds:
        ...
        fund_lines.append(
            (
                ...
                f"7D Return: {fund.get('seven_day_return_percent', 'unknown')}%, "
                f"30D Return: {fund.get('thirty_day_return_percent', 'unknown')}%, "
                f"Max Daily Change 7D: {fund.get('max_daily_change_7d', 'unknown')}%, "
                f"Trend 7D: {fund.get('trend_7d', 'unknown')}, "
                f"Drawdown 30D: {fund.get('drawdown_30d', 'unknown')}%, "
